...
QT_MOC_LITERAL(1, 8, 18), // "slideChangedBefore"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 17) // "slideChangedAfter"

    },
    "Drawing\0slideChangedBefore\0\0"
    "slideChangedAfter"
};
...
void Drawing::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Drawing::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Drawing::slideChangedBefore)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Drawing::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Drawing::slideChangedAfter)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject Drawing::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_Drawing.data,
...
// SIGNAL 0
void Drawing::slideChangedBefore()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Drawing::slideChangedAfter()
{
